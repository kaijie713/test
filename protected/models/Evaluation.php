...
class Evaluation extends BaseModel
{
	...
	public function preparePdetail($pdetail)
    {
        $arr =  array();
        ...
        foreach ($pdetail['type'] as $key => $value) {
            $arr['sell_house_num'] =  $arr['sell_house_num'] +  $pdetail['sell_house_num'][$key];
            $arr['ajcard_price'] =  $arr['ajcard_price'] +  $pdetail['ajcard_price'][$key];
            $arr['pre_volumn'] =  $arr['pre_volumn'] +  $pdetail['pre_volumn'][$key];
            $arr['prjreword_perunit'] =  $arr['prjreword_perunit'] +  $pdetail['prjreword_perunit'][$key];
            $arr['prevolumn_perunit'] =  $arr['prevolumn_perunit'] +  $pdetail['prevolumn_perunit'][$key];
            $arr['brokerfees_perunit'] =  $arr['brokerfees_perunit'] +  $pdetail['brokerfees_perunit'][$key];
            $arr['prebrokervolumn'] =  $arr['prebrokervolumn'] +  $pdetail['prebrokervolumn'][$key];
            $arr['pre_amount'] =  $arr['pre_amount'] +  $pdetail['pre_amount'][$key];
            $arr['commission_rate'] =  $arr['commission_rate'] +  $pdetail['commission_rate'][$key];
            $arr['commission_perunit'] =  $arr['commission_perunit'] +  $pdetail['commission_perunit'][$key];
            $arr['pre_commission_amount'] =  $arr['pre_commission_amount'] +  $pdetail['pre_commission_amount'][$key];
            $arr['pre_incoming'] =  $arr['pre_incoming'] +  $pdetail['pre_incoming'][$key];
            $arr['jd_retain_ratio'] =  $arr['jd_retain_ratio'] +  $pdetail['jd_retain_ratio'][$key];
            $arr['jd_retain_amount'] =  $arr['jd_retain_amount'] +  $pdetail['jd_retain_amount'][$key];
            $arr['divideSum'] =  $arr['divideSum'] +  $pdetail['divideSum'][$key];
            $arr['divideAmountSum'] =  $arr['divideAmountSum'] +  $pdetail['divideAmountSum'][$key];
            $arr['splitdetailNum'] =  $arr['splitdetailNum'] +  $pdetail['splitdetailNum'][$key];
            $arr['divideSumKaifashang'] =  $arr['divideSumKaifashang'] +  $pdetail['divideSumKaifashang'][$key];
            $arr['divideAmountKaifashang'] =  $arr['divideAmountKaifashang'] +  $pdetail['divideAmountKaifashang'][$key];
            $arr['divideSumDisanfang'] =  $arr['divideSumDisanfang'] +  $pdetail['divideSumDisanfang'][$key];
            $arr['divideAmountSumDisanfang'] =  $arr['divideAmountSumDisanfang'] +  $pdetail['divideAmountSumDisanfang'][$key];
	...
	public function getPrjrewordAndBrokerfees($pdetail){
        ...
        foreach ($pdetail['type'] as $key => $value) {
        	$anchang  = $pdetail['prjreword_perunit'][$key] * $pdetail['prevolumn_perunit'][$key]+ $anchang;
        	$jingjiren  = $pdetail['brokerfees_perunit'][$key] * $pdetail['prebrokervolumn'][$key]+ $anchang;
        }
