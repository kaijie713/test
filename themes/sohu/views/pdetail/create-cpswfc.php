	    ...
	    <div class="modal-body row-fluid wt-at">
				<div class="span6">
					...
					<div class="form-group control-group">
						...
						<div class="controls">
						    <div class="input-prepend input-append">
						  		<input type="text" readonly class="form-control span11" value ="<?php echo isset($model['pre_incoming'])?F::d2($model['pre_incoming']):'';?>"  name="" id="yujimaoshouru"/>
					...
					<div class="form-group control-group">
						<label class="control-label" for="commission_rate"><span class="color-danger">*</span>佣金比例：</label>
						<div class="controls">
						    <div class="input-prepend input-append">
