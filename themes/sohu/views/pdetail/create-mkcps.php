			...
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-md-6 controls">
					    <div class="input-group ">
					  		<div class="input-group">
						  		<input type="text" readonly value="<?php echo isset($model['pre_incoming'])?$model['pre_incoming']:'';?>" class="form-control" id="yujimaoshouru"/>
				...
				<div class="form-group">
					...
					<div class="col-md-6 controls">
					    <div class="input-group ">
					  		<div class="input-group">
						  		<input type="text"  class="form-control" value="<?php echo isset($model['ajcard_price'])?$model['ajcard_price']:'';?>" name="Pdetail[ajcard_price]" id="ajcard_price"/>
						  		<span class="input-group-addon">元</span>
						  	</div>
					  	</div>
					</div>
