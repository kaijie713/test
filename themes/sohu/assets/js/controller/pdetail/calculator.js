define(function(require, exports, module) {
    ...
    var Calculator = Widget.extend({
        ...
        prepare: function() {
            ...
            arr['ajcard_price'] = $("#ajcard_price").length > 0 && $("#ajcard_price").val() != '' && !isNaN($("#ajcard_price").val()) ? parseFloat($("#ajcard_price").val()).toFixed(2) : 0 ;
            arr['pre_volumn'] = $("#pre_volumn").length > 0 && $("#pre_volumn").val() != '' && !isNaN($("#pre_volumn").val()) ? parseFloat($("#pre_volumn").val()).toFixed(0) : 0 ;
            arr['prjreword_perunit'] = $("#prjreword_perunit").length > 0 && $("#prjreword_perunit").val() != '' && !isNaN($("#prjreword_perunit").val()) ? parseFloat($("#prjreword_perunit").val()).toFixed(2) : 0 ;
            ...
            arr['brokerfees_perunit'] = $("#brokerfees_perunit").length > 0 && $("#brokerfees_perunit").val() != '' && !isNaN($("#brokerfees_perunit").val()) ? parseFloat($("#brokerfees_perunit").val()).toFixed(2) : 0 ;
            ...
            arr['pre_amount'] = $("#pre_amount").length > 0 && $("#pre_amount").val() != '' && !isNaN($("#pre_amount").val()) ? parseFloat($("#pre_amount").val()).toFixed(2) : 0 ;
            arr['commission_rate'] = $("#commission_rate").length > 0 && $("#commission_rate").val() != '' && !isNaN($("#commission_rate").val()) ? parseFloat($("#commission_rate").val()).toFixed(2) : 0 ;
            arr['commission_perunit'] = $("#commission_perunit").length > 0 && $("#commission_perunit").val() != '' && !isNaN($("#commission_perunit").val()) ? parseFloat($("#commission_perunit").val()).toFixed(2) : 0 ;
            arr['pre_commission_amount'] = $("#pre_commission_amount").length > 0 && $("#pre_commission_amount").val() != '' && !isNaN($("#pre_commission_amount").val()) ? parseFloat($("#pre_commission_amount").val()).toFixed(2) : 0 ;
            arr['pre_incoming'] = $("#pre_incoming").length > 0 && $("#pre_incoming").val() != '' && !isNaN($("#pre_incoming").val()) ? parseFloat($("#pre_incoming").val()).toFixed(2) : 0 ;
            arr['jd_retain_ratio'] = $("#jd_retain_ratio").length > 0 && $("#jd_retain_ratio").val() != '' && !isNaN($("#jd_retain_ratio").val()) ? parseFloat($("#jd_retain_ratio").val()).toFixed(2) : 0 ;
            arr['jd_retain_amount'] = $("#jd_retain_amount").length > 0 && $("#jd_retain_amount").val() != '' && !isNaN($("#jd_retain_amount").val()) ? parseFloat($("#jd_retain_amount").val()).toFixed(2) : 0 ;
